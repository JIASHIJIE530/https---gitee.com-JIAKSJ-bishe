...
<script>
import { listInfo, getInfo, delInfo, addInfo, updateInfo } from "@/api/notice/info";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('notice/info/export', {
        ...this.queryParams
